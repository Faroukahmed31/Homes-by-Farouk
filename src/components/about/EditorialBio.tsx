    ...
    <section className="px-6 md:px-20 py-16 md:py-24 max-w-[1440px] mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
        ...
        >
          ...
          <p className="font-sans text-base text-on-tertiary-fixed-variant leading-relaxed">
        ...
        >
          <p className="font-sans text-base text-on-tertiary-fixed-variant mb-8 leading-relaxed">
